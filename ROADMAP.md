...
- [ ] M10: Map ↔ filter integration — when filters are applied, map_controller hides non-matching PWS polygons (pws/pws_outline/pws_points layers) via Mapbox GL setFilter; resets to show all on clear; applies on page load from URL params. URL state management already done. See scratch/roadmap_m10/m10_guide.md. {depends: M5, M6, M7}
