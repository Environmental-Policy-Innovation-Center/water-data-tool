...
### Mobile Issues
  Refactor stylings to develop mobile first styling - using Tailwinds built in configs
  Link stats bar icon to functionality
  Link filters icon to functionality
  - may require a different html block
  - may require finding a new svg
